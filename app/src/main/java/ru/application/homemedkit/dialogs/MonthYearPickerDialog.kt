            ...
            Column(
                ...
                Row(Modifier.fillMaxWidth(), Arrangement.End) {
                    ...
                    TextButton(onClick = { onCancel() }) {
                        Text(
                            text = LocalContext.current.getString(R.string.text_cancel),
                            color = MaterialTheme.colorScheme.onSurface,
                            fontSize = 20.sp,
                            fontWeight = FontWeight.Medium
                        )
                    ...
                    TextButton(
                        onClick = { onConfirm(months.indexOf(month) + 1, year) }
                    ) {
                        Text(
                            text = LocalContext.current.getString(R.string.text_save),
                            color = MaterialTheme.colorScheme.onSurface,
                            fontSize = 20.sp,
                            fontWeight = FontWeight.Medium
                        )
